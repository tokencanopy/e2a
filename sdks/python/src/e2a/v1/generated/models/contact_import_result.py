...
class ContactImportResult(BaseModel):
    ...
    ContactImportResult
    """ # noqa: E501
    batch_id: StrictStr = Field(description="Identifier for this import. Pass it to DELETE /v1/contacts/imports/{batch_id} to reverse the upload, or as a filter on the contacts list.")
    created: StrictInt
    failed: StrictInt
    results: List[ContactImportItemResult] = Field(description="One entry per submitted row, in request order.")
    skipped: StrictInt
    updated: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["batch_id", "created", "failed", "results", "skipped", "updated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContactImportResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContactImportResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [ContactImportItemResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
