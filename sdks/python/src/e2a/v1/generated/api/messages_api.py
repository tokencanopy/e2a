...
class MessagesApi:
    ...
    async def get_agent_metrics(
        ...
        _param = self._get_agent_metrics_serialize(
            email=email,
            start=start,
            end=end,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def get_agent_metrics_with_http_info(
        self,
        email: StrictStr,
        start: Annotated[Optional[datetime], Field(description="Inclusive start of the cohort window (RFC 3339). Defaults to 30 days before end.")] = None,
        end: Annotated[Optional[datetime], Field(description="Exclusive end of the cohort window (RFC 3339). Defaults to now.")] = None,
    ...
    @validate_call
    async def get_agent_metrics_without_preload_content(
        self,
        email: StrictStr,
        start: Annotated[Optional[datetime], Field(description="Inclusive start of the cohort window (RFC 3339). Defaults to 30 days before end.")] = None,
        end: Annotated[Optional[datetime], Field(description="Exclusive end of the cohort window (RFC 3339). Defaults to now.")] = None,
    ...
    def _get_agent_metrics_serialize(
        self,
        email,
        start,
        end,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/agents/{email}/metrics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
