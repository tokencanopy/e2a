 ...
 * no description
 */
export declare class ReviewsApiRequestFactory extends BaseAPIRequestFactory {
    /**
     ...
     */
    approveReview(id: string, approveRequest: ApproveRequest, idempotencyKey?: string, _options?: Configuration): Promise<RequestContext>;
    /**
     ...
     * @param id
     */
    getReview(id: string, _options?: Configuration): Promise<RequestContext>;
    /**
     ...
     */
    listReviews(cursor?: string, limit?: number, _options?: Configuration): Promise<RequestContext>;
    /**
     ...
     * @param rejectRequest
     */
    rejectReview(id: string, rejectRequest: RejectRequest, _options?: Configuration): Promise<RequestContext>;
}
export declare class ReviewsApiResponseProcessor {
    /**
     ...
     */
    approveReviewWithHttpInfo(response: ResponseContext): Promise<HttpInfo<SendResultView>>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    getReviewWithHttpInfo(response: ResponseContext): Promise<HttpInfo<MessageView>>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listReviewsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<PageReviewView>>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    rejectReviewWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RejectResultView>>;
}
