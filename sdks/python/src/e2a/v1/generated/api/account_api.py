...
class AccountApi:
    ...
    @validate_call
    async def create_sending_access_request(
        self,
        sending_access_request_input: SendingAccessRequestInput,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._create_sending_access_request_serialize(
            sending_access_request_input=sending_access_request_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def create_sending_access_request_with_http_info(
        self,
        sending_access_request_input: SendingAccessRequestInput,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_sending_access_request_without_preload_content(
        self,
        sending_access_request_input: SendingAccessRequestInput,
        _request_timeout: Union[
            None,
    ...
    def _create_sending_access_request_serialize(
        self,
        sending_access_request_input,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if sending_access_request_input is not None:
            _body_params = sending_access_request_input
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/account/sending-access/request',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def get_account_metrics_with_http_info(
        self,
        start: Annotated[Optional[datetime], Field(description="Inclusive start of the cohort window (RFC 3339). Defaults to 30 days before end.")] = None,
        end: Annotated[Optional[datetime], Field(description="Exclusive end of the cohort window (RFC 3339). Defaults to now.")] = None,
        bucket: Annotated[Optional[StrictStr], Field(description="Set to 'day' to also receive per-day buckets for charting. Buckets are UTC calendar days — a boundary that moved with the reader's timezone would make two people comparing the same chart see different daily numbers.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountMetricsView]:
        """Get account-wide delivery metrics (beta)
    ...
    @validate_call
    async def get_account_metrics_without_preload_content(
        self,
        start: Annotated[Optional[datetime], Field(description="Inclusive start of the cohort window (RFC 3339). Defaults to 30 days before end.")] = None,
        end: Annotated[Optional[datetime], Field(description="Exclusive end of the cohort window (RFC 3339). Defaults to now.")] = None,
        bucket: Annotated[Optional[StrictStr], Field(description="Set to 'day' to also receive per-day buckets for charting. Buckets are UTC calendar days — a boundary that moved with the reader's timezone would make two people comparing the same chart see different daily numbers.")] = None,
    ...
    @validate_call
    async def get_sending_access_request(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_sending_access_request_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_sending_access_request_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_sending_access_request_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_sending_access_request_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
