...
class AgentSignupRestrictionsView(BaseModel):
    """
    AgentSignupRestrictionsView
    """ # noqa: E501
    can_create_identities: StrictBool
    can_receive_from: StrictStr = Field(description="Always anyone while pending.")
    send_to: Optional[List[StrictStr]] = Field(description="The only recipient allowed while pending.")
    sends_per_24h: StrictInt
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["can_create_identities", "can_receive_from", "send_to", "sends_per_24h"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentSignupRestrictionsView from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if send_to (nullable) is None
        # and model_fields_set contains the field
        if self.send_to is None and "send_to" in self.model_fields_set:
            _dict['send_to'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentSignupRestrictionsView from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "can_create_identities": obj.get("can_create_identities"),
            "can_receive_from": obj.get("can_receive_from"),
            "send_to": obj.get("send_to"),
            "sends_per_24h": obj.get("sends_per_24h")
        })
