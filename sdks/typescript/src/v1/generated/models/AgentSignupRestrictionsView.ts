...
export class AgentSignupRestrictionsView {
    'canCreateIdentities': boolean;
    /**
    * Always anyone while pending.
    */
    'canReceiveFrom': string;
    /**
    * The only recipient allowed while pending.
    */
    'sendTo': Array<string> | null;
    'sendsPer24h': number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "canCreateIdentities",
            "baseName": "can_create_identities",
            "type": "boolean",
            "format": ""
        },
        {
            "name": "canReceiveFrom",
            "baseName": "can_receive_from",
            "type": "string",
            "format": ""
        },
        {
        ...
        {
            "name": "sendsPer24h",
            "baseName": "sends_per_24h",
            "type": "number",
            "format": "int64"
        }    ];

    static getAttributeTypeMap() {
        return AgentSignupRestrictionsView.attributeTypeMap;
    }
