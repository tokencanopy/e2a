...
class SendBatchRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendBatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendBatchRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "messages": [BatchMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
