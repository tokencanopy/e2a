...
class PageAgentSignupView(BaseModel):
    """
    PageAgentSignupView
    """ # noqa: E501
    items: List[AgentSignupView]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageAgentSignupView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageAgentSignupView from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [AgentSignupView.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
