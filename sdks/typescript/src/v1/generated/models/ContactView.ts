...
export class ContactView {
    /**
    * Canonical (normalized) email address. This is the resource key: a display-name form such as \"A. Partner <partner@fund.vc>\" and the bare address resolve to the same contact.
    */
    'address': string;
    'createdAt': Date;
    /**
    ...
    */
    'displayName': string;
    /**
    * The import that created this contact, when source is import. Absent otherwise.
    */
    ...
    */
    ...
    /**
    * How this contact first entered the account — provenance, not lifecycle; it never changes after creation. Open set; tolerate unknown values. Known values: import, manual, inbound.
    */
    'source': string;
    'updatedAt': Date;
    ...
    static getAttributeTypeMap() {
        return ContactView.attributeTypeMap;
    }
