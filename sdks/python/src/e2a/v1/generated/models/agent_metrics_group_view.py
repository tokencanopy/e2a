...
class AgentMetricsGroupView(BaseModel):
    """
    AgentMetricsGroupView
    """ # noqa: E501
    agent_email: StrictStr
    counters: Optional[List[MetricsCounterView]] = Field(description="Every reason code this agent produced in the window, ordered by code.")
    messages_in_window: StrictInt
    messages_with_lifecycle: StrictInt
    rates: MetricsRatesView
    reconstructed_observations: StrictInt
    summary: MetricsSummaryView
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["agent_email", "counters", "messages_in_window", "messages_with_lifecycle", "rates", "reconstructed_observations", "summary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentMetricsGroupView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentMetricsGroupView from a dict"""
        if obj is None:
            return None
