...
class VerifyAgentSignupRequest(BaseModel):
    """
    VerifyAgentSignupRequest
    """ # noqa: E501
    code: Annotated[str, Field(strict=True)] = Field(description="Six-digit code sent to human_email.")
    review_outbound: Optional[StrictBool] = Field(default=None, description="If true, outbound to recipients other than the human enters the existing review queue after verification.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["code", "review_outbound"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyAgentSignupRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyAgentSignupRequest from a dict"""
        if obj is None:
            return None
