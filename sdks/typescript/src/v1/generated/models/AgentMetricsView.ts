...
export class AgentMetricsView {
    /**
    * The agent these metrics describe.
    */
    'agentEmail': string;
    /**
    * Every reason code observed in the window, ordered by code. Codes with no observations are omitted rather than reported as zero.
    */
    ...
    */
    'end': Date;
    /**
    * Messages created in the window, from the message table itself.
    */
    ...
    */
    ...
    /**
    * Observations in the window derived from durable message state rather than recorded at the boundary. Included in the counts above; reported separately so the inferred share is visible.
    */
    ...
    */
    ...
    static getAttributeTypeMap() {
        return AgentMetricsView.attributeTypeMap;
    }
