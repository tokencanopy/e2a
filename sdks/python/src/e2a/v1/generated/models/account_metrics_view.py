...
class AccountMetricsView(BaseModel):
    """
    AccountMetricsView
    """ # noqa: E501
    ...
    rates: MetricsRatesView = Field(description="Account-wide rates, on the same fixed denominators the per-agent operation uses.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountMetricsView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountMetricsView from a dict"""
        if obj is None:
            return None
