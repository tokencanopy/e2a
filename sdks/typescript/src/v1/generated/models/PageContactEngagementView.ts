...
export class PageContactEngagementView {
    'items': Array<ContactEngagementView>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "items",
            "baseName": "items",
            "type": "Array<ContactEngagementView>",
            "format": ""
        },
        {
            "name": "nextCursor",
    ...
    static getAttributeTypeMap() {
        return PageContactEngagementView.attributeTypeMap;
    }
