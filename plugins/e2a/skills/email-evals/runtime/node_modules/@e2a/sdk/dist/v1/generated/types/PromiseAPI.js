import { wrapOptions } from '../configuration.js';
...
export class PromiseAccountApi {
     ...
     */
    createApiKeyWithHttpInfo(createAPIKeyRequest, idempotencyKey, _options) {
     ...
     * @param [idempotencyKey] Optional idempotency key for safe retries (unique per logical request). A retry with the same key and byte-identical body replays the first request\&#39;s response — the SAME key — instead of minting a second live credential. Completed keys are remembered for at least 24 hours (the published minimum dedup window). Within the window: same key + different body → 422 idempotency_key_reuse (do not retry as-is); same key while the first request is still executing → 409 idempotency_in_flight (wait, then retry unchanged). Dedup is best-effort: under idempotency-store degradation or a mid-request crash the guarantee degrades to at-least-once — a keyed retry may mint a new key rather than replay.
     */
    createApiKey(createAPIKeyRequest, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    deleteAccountWithHttpInfo(confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteAccount(confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteApiKeyWithHttpInfo(id, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteApiKey(id, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteSuppressionWithHttpInfo(address, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteSuppression(address, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    exportAccountWithHttpInfo(_options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    getAccountWithHttpInfo(_options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    listApiKeysWithHttpInfo(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listApiKeys(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listSuppressionsWithHttpInfo(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listSuppressions(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
...
export class PromiseAgentsApi {
     ...
     */
    createAgentWithHttpInfo(createAgentRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param createAgentRequest
     */
    createAgent(createAgentRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    createAgentSuppressionWithHttpInfo(email, createAgentSuppressionRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param createAgentSuppressionRequest
     */
    createAgentSuppression(email, createAgentSuppressionRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    deleteAgentWithHttpInfo(email, confirm, permanent, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [permanent] Delete irreversibly right away instead of moving to the trash. Accepts live and trashed agents.
     */
    deleteAgent(email, confirm, permanent, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteAgentSuppressionWithHttpInfo(email, address, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteAgentSuppression(email, address, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    getAgentWithHttpInfo(email, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    getAgentProtectionWithHttpInfo(email, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param email The agent\&#39;s full email address.
     */
    getAgentProtection(email, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listAgentSuppressionsWithHttpInfo(email, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listAgentSuppressions(email, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    listAgentsWithHttpInfo(cursor, limit, deleted, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [deleted] List the trash instead: agents that were soft-deleted and are restorable until purged (30 days after deletion by default, deployment-configurable). Defaults to false (live agents only).
     */
    listAgents(cursor, limit, deleted, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    putAgentProtectionWithHttpInfo(email, protectionConfigRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param protectionConfigRequest
     */
    putAgentProtection(email, protectionConfigRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param email The agent\&#39;s full email address, e.g. support@acme.com.
     */
    restoreAgentWithHttpInfo(email, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param email The agent\&#39;s full email address, e.g. support@acme.com.
     */
    testAgentWithHttpInfo(email, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    updateAgentWithHttpInfo(email, updateAgentRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param updateAgentRequest
     */
    updateAgent(email, updateAgentRequest, _options) {
        const observableOptions = wrapOptions(_options);
...
export class PromiseContactsApi {
     ...
     */
    createContactWithHttpInfo(createContactRequest, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [idempotencyKey] Optional idempotency key for safe retries (unique per logical request). A retry with the same key and byte-identical body replays the first response instead of creating a second contact. Within the dedup window: same key + different body → 422 idempotency_key_reuse; same key while the first request is still executing → 409 idempotency_in_flight.
     */
    createContact(createContactRequest, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteContactWithHttpInfo(address, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteContact(address, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteEngagementWithHttpInfo(email, address, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteEngagement(email, address, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteImportBatchWithHttpInfo(batchId, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteImportBatch(batchId, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    getContactWithHttpInfo(address, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param address
     */
    getEngagementWithHttpInfo(email, address, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param address
     */
    getEngagement(email, address, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    importContactsWithHttpInfo(importContactsRequest, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [idempotencyKey] Optional idempotency key for safe retries (unique per logical request). A retry with the same key and byte-identical body replays the first response — including the original batch_id and per-row results — instead of importing the rows a second time. Strongly recommended: an import that times out after the rows landed is otherwise indistinguishable from one that failed.
     */
    importContacts(importContactsRequest, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listContactsWithHttpInfo(source, importBatchId, createdAfter, createdBefore, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listContacts(source, importBatchId, createdAfter, createdBefore, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listEngagementsWithHttpInfo(email, stage, replied, suppressed, nextActionBefore, lastOutboundBefore, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listEngagements(email, stage, replied, suppressed, nextActionBefore, lastOutboundBefore, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    updateContactWithHttpInfo(address, updateContactRequest, ifMatch, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [ifMatch] Optional ETag from a prior read. When present it must still match at the instant of the write or the update is rejected with 412. Send the ETag exactly as returned; a W/-prefixed weak form of the same validator is also accepted, because a transforming CDN may weaken it in transit. * matches any existing representation. Sending the header with an empty value is a 400 invalid_request, not an unconditional write — omit the header entirely to write unconditionally.
     */
    updateContact(address, updateContactRequest, ifMatch, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    upsertEngagementWithHttpInfo(email, address, upsertEngagementRequest, ifMatch, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [ifMatch] Optional ETag from a prior read. When present the engagement must already exist and still match at the instant of the write, or the update is rejected with 412. Send the ETag exactly as returned; a W/-prefixed weak form of the same validator is also accepted, because a transforming CDN may weaken it in transit. * matches any existing representation, so it still refuses to enrol a missing one. Sending the header with an empty value is a 400 invalid_request, not an unconditional write — omit the header entirely to write unconditionally.
     */
    upsertEngagement(email, address, upsertEngagementRequest, ifMatch, _options) {
        const observableOptions = wrapOptions(_options);
...
export class PromiseConversationsApi {
     ...
     * @param id
     */
    getConversationWithHttpInfo(email, id, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param id
     */
    getConversation(email, id, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit]
     */
    listConversationsWithHttpInfo(email, since, until, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit]
     */
    listConversations(email, since, until, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
...
export class PromiseDomainsApi {
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteDomainWithHttpInfo(domain, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteDomain(domain, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param domain
     */
    getDomainWithHttpInfo(domain, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listDomainsWithHttpInfo(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listDomains(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    registerDomainWithHttpInfo(registerDomainRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param registerDomainRequest
     */
    registerDomain(registerDomainRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param domain
     */
    verifyDomainWithHttpInfo(domain, _options) {
        const observableOptions = wrapOptions(_options);
...
export class PromiseEventsApi {
     ...
     * @param [limit]
     */
    listEventsWithHttpInfo(type, agentEmail, conversationId, messageId, since, until, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit]
     */
    listEvents(type, agentEmail, conversationId, messageId, since, until, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    redeliverEventWithHttpInfo(id, redeliverEventRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param redeliverEventRequest
     */
    redeliverEvent(id, redeliverEventRequest, _options) {
        const observableOptions = wrapOptions(_options);
...
export class PromiseMessagesApi {
     ...
     */
    deleteMessageWithHttpInfo(email, id, permanent, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [confirm] Must be the literal string DELETE when permanent&#x3D;true; ignored otherwise.
     */
    deleteMessage(email, id, permanent, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    forwardMessageWithHttpInfo(email, id, forwardRequest, idempotencyKey, wait, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [wait] Optional bounded wait. wait&#x3D;sent holds an immediately queued forward until it reaches a terminal-or-held state or at most 20 seconds elapse (currently ~15s), then returns the observed state; on timeout returns status&#x3D;accepted. A future send_at returns status&#x3D;scheduled immediately and does not wait for the scheduled time. Default: no wait. Always branch on body.status, not the HTTP code.
     */
    forwardMessage(email, id, forwardRequest, idempotencyKey, wait, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    getAttachmentWithHttpInfo(email, id, index, inline, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [inline] When true, also include the bytes as base64 in \&#39;data\&#39; — ONLY for attachments &lt;&#x3D; 256 KB; larger inline requests are rejected (413). Default false (use download_url).
     */
    getAttachment(email, id, index, inline, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param id The message id, e.g. msg_abc123.
     */
    getMessageWithHttpInfo(email, id, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    getMessageLifecycleWithHttpInfo(email, id, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of lifecycle transitions to return (1-100).
     */
    getMessageLifecycle(email, id, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    listMessagesWithHttpInfo(email, direction, readStatus, sort, from_, subjectContains, conversationId, labels, since, until, cursor, limit, deleted, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [deleted] List the trash instead: messages that were soft-deleted and are restorable until purged (30 days after deletion by default, deployment-configurable). Defaults to false (live messages only).
     */
    listMessages(email, direction, readStatus, sort, from_, subjectContains, conversationId, labels, since, until, cursor, limit, deleted, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    replyToMessageWithHttpInfo(email, id, replyRequest, idempotencyKey, wait, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [wait] Optional bounded wait. wait&#x3D;sent holds an immediately queued reply until it reaches a terminal-or-held state or at most 20 seconds elapse (currently ~15s), then returns the observed state; on timeout returns status&#x3D;accepted. A future send_at returns status&#x3D;scheduled immediately and does not wait for the scheduled time. Default: no wait. Always branch on body.status, not the HTTP code.
     */
    replyToMessage(email, id, replyRequest, idempotencyKey, wait, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param id The message id, e.g. msg_abc123.
     */
    restoreMessageWithHttpInfo(email, id, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param id The message id, e.g. msg_abc123.
     */
    restoreMessage(email, id, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    sendMessageWithHttpInfo(email, sendEmailRequest, idempotencyKey, wait, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [wait] Optional bounded wait. wait&#x3D;sent holds an immediately queued message until it reaches a terminal-or-held state or at most 20 seconds elapse (currently ~15s), then returns the observed state; on timeout returns status&#x3D;accepted. A future send_at returns status&#x3D;scheduled immediately and does not wait for the scheduled time. Default: no wait. Always branch on body.status, not the HTTP code.
     */
    sendMessage(email, sendEmailRequest, idempotencyKey, wait, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    updateMessageWithHttpInfo(email, id, updateMessageRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param updateMessageRequest
     */
    updateMessage(email, id, updateMessageRequest, _options) {
        const observableOptions = wrapOptions(_options);
...
export class PromiseReviewsApi {
     ...
     */
    approveReviewWithHttpInfo(id, approveRequest, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [idempotencyKey] Optional idempotency key for safe retries (unique per logical request). A retry with the same key and byte-identical body replays the first request\&#39;s response instead of re-executing it. Completed keys are remembered for at least 24 hours (the published minimum dedup window). Within the window: same key + different body → 422 idempotency_key_reuse (do not retry as-is); same key while the first request is still executing → 409 idempotency_in_flight (wait, then retry unchanged). Dedup is best-effort: under idempotency-store degradation or a mid-request crash the guarantee degrades to at-least-once — a keyed retry may re-execute rather than replay.
     */
    approveReview(id, approveRequest, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param id
     */
    getReviewWithHttpInfo(id, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listReviewsWithHttpInfo(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listReviews(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param rejectRequest
     */
    rejectReviewWithHttpInfo(id, rejectRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param rejectRequest
     */
    rejectReview(id, rejectRequest, _options) {
        const observableOptions = wrapOptions(_options);
...
export class PromiseTemplatesApi {
     ...
     */
    createTemplateWithHttpInfo(createTemplateRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteTemplateWithHttpInfo(id, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteTemplate(id, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    getStarterTemplateWithHttpInfo(alias, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param alias The starter template\&#39;s alias, e.g. welcome.
     */
    getStarterTemplate(alias, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param id
     */
    getTemplateWithHttpInfo(id, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listStarterTemplatesWithHttpInfo(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listStarterTemplates(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listTemplatesWithHttpInfo(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listTemplates(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    updateTemplateWithHttpInfo(id, updateTemplateRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param updateTemplateRequest
     */
    updateTemplate(id, updateTemplateRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    validateTemplateWithHttpInfo(validateTemplateRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param validateTemplateRequest
     */
    validateTemplate(validateTemplateRequest, _options) {
        const observableOptions = wrapOptions(_options);
...
export class PromiseWebhooksApi {
     ...
     */
    createWebhookWithHttpInfo(createWebhookRequest, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [idempotencyKey] Optional idempotency key for safe retries (unique per logical request). A retry with the same key and byte-identical body replays the first request\&#39;s response — the SAME webhook id and one-time signing secret — instead of registering a second active subscription. Completed keys are remembered for at least 24 hours (the published minimum dedup window). Within the window: same key + different body → 422 idempotency_key_reuse (do not retry as-is); same key while the first request is still executing → 409 idempotency_in_flight (wait, then retry unchanged). A keyed create commits the webhook and its replay response atomically, so an accepted create always replays; dedup is best-effort only under idempotency-store degradation before that commit.
     */
    createWebhook(createWebhookRequest, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteWebhookWithHttpInfo(id, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param confirm Must be the literal DELETE — this action is irreversible.
     */
    deleteWebhook(id, confirm, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param id
     */
    getWebhookWithHttpInfo(id, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit]
     */
    listWebhookDeliveriesWithHttpInfo(id, status, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit]
     */
    listWebhookDeliveries(id, status, cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listWebhooksWithHttpInfo(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [limit] Maximum number of items to return (1-100).
     */
    listWebhooks(cursor, limit, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [idempotencyKey] Optional idempotency key for safe retries (unique per logical request). A retry with the same key and byte-identical body replays the first request\&#39;s response instead of re-executing it. Completed keys are remembered for at least 24 hours (the published minimum dedup window). Within the window: same key + different body → 422 idempotency_key_reuse (do not retry as-is); same key while the first request is still executing → 409 idempotency_in_flight (wait, then retry unchanged). Dedup is best-effort: under idempotency-store degradation or a mid-request crash the guarantee degrades to at-least-once — a keyed retry may re-execute rather than replay.
     */
    rotateWebhookSecretWithHttpInfo(id, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [idempotencyKey] Optional idempotency key for safe retries (unique per logical request). A retry with the same key and byte-identical body replays the first request\&#39;s response instead of re-executing it. Completed keys are remembered for at least 24 hours (the published minimum dedup window). Within the window: same key + different body → 422 idempotency_key_reuse (do not retry as-is); same key while the first request is still executing → 409 idempotency_in_flight (wait, then retry unchanged). Dedup is best-effort: under idempotency-store degradation or a mid-request crash the guarantee degrades to at-least-once — a keyed retry may re-execute rather than replay.
     */
    rotateWebhookSecret(id, idempotencyKey, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    testWebhookWithHttpInfo(id, testWebhookRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param testWebhookRequest
     */
    testWebhook(id, testWebhookRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     */
    updateWebhookWithHttpInfo(id, updateWebhookRequest, _options) {
        const observableOptions = wrapOptions(_options);
     ...
     * @param updateWebhookRequest
     */
    updateWebhook(id, updateWebhookRequest, _options) {
        const observableOptions = wrapOptions(_options);
