...
export class DeleteImportBatchResult {
    'batchId': string;
    /**
    * How many contacts this reversal removed.
    */
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "contactsDeleted",
            "baseName": "contacts_deleted",
            "type": "number",
            "format": "int64"
        },
        {
            "name": "contactsRetained",
            "baseName": "contacts_retained",
            "type": "number",
            "format": "int64"
        },
        {
    ...
    static getAttributeTypeMap() {
        return DeleteImportBatchResult.attributeTypeMap;
    }
