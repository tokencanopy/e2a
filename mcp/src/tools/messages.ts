      ...
      inputSchema: strictInputSchema({
        ...
        q: z
          ...
          .refine((value) => Array.from(value).length <= 500, {
            message: "q must contain at most 500 Unicode code points",
          })
          .optional()
          .describe(
