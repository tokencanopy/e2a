...
class ApproveAgentSignupInputBody(BaseModel):
    """
    ApproveAgentSignupInputBody
    """ # noqa: E501
    review_outbound: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["review_outbound"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApproveAgentSignupInputBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApproveAgentSignupInputBody from a dict"""
        if obj is None:
            return None
