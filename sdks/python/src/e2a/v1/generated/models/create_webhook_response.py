...
class CreateWebhookResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["auto_disabled_at", "auto_disabled_reason", "created_at", "description", "enabled", "events", "filters", "id", "last_delivered_at", "signing_secret", "url"]
