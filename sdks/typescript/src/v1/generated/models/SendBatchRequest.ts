...
export class SendBatchRequest {
    /**
    * 1..100 BatchMessage items. Each item is a self-contained near-clone of SendEmailRequest minus from — its own to/cc/bcc/content/attachments/template/reply_to. Ordering is significant: results[] in the response is positionally aligned with this array.
    */
    'messages': Array<BatchMessage>;
    /**
    * Optional batch-level Reply-To default. Applied to any item that leaves reply_to empty; a per-item value always wins. This is the ONLY batch-level default in MVP; every other field is per-item (docs/design/batch-send.md §1.2).
    */
    'replyTo'?: string;
    ...
    static getAttributeTypeMap() {
        return SendBatchRequest.attributeTypeMap;
    }
