...
export class VerifyAgentSignupRequest {
    /**
    * Six-digit code sent to human_email.
    */
    'code': string;
    /**
    * If true, outbound to recipients other than the human enters the existing review queue after verification.
    */
    ...
    static getAttributeTypeMap() {
        return VerifyAgentSignupRequest.attributeTypeMap;
    }
