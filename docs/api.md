...
| [Scheduled queue](#scheduled-queue-v1scheduled-messages-beta) | **beta** | `listScheduledMessages` |
...
| `listScheduledMessages` | `GET /v1/scheduled-messages` | Scheduled |
...
### Scheduled queue (`/v1/scheduled-messages`) (beta)
...
- `GET /v1/scheduled-messages` — list the scheduled sends across the account's inboxes,
