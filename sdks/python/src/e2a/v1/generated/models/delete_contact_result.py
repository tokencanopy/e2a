...
class DeleteContactResult(BaseModel):
    ...
    DeleteContactResult
    """ # noqa: E501
    address: StrictStr = Field(description="The canonical address that was removed.")
    deleted: StrictBool = Field(description="Always true; the operation is a no-op-safe confirmation.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteContactResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteContactResult from a dict"""
        if obj is None:
            return None
