...
export class MetricsCounterView {
    /**
    * Distinct messages carrying at least one observation of this code. This is the grain funnel arithmetic uses.
    */
    'messages': number;
    /**
    * Ledger rows. Retryable codes are recorded once per attempt, so this exceeds messages whenever the pipeline retried.
    */
    'observations': number;
    /**
    * What e2a observed at that stage.
    */
    'outcome': string;
    /**
    * Canonical lifecycle reason code.
    */
    'reasonCode': string;
    /**
    * Whether this observation describes a condition the pipeline retries.
    */
    'retryable': boolean;
    /**
    * Lifecycle stage the observation was made at.
    */
    'stage': string;
    ...
    static getAttributeTypeMap() {
        return MetricsCounterView.attributeTypeMap;
    }
